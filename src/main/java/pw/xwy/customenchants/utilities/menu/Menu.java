...
import static pw.xwy.customenchants.utilities.menu.MenuUtility.getItem;
import static pw.xwy.customenchants.utilities.menu.MenuUtility.setItem;
...
public class Menu {
	...
	Menu(ItemSets type) {
		...
		for (CustomEnchant customEnchant : CustomEnchants.manager.getEnchantsByRealName().values()) {
