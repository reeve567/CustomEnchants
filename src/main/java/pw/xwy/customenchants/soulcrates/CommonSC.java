...
public class CommonSC extends Crate {
	...
	public CommonSC() {
		...
		prizes.add(new Prize(bundle.getString("64Diamonds"), new ItemStack(Material.DIAMOND, 64)));
		prizes.add(new Prize(bundle.getString("32Diamonds"), new ItemStack(Material.DIAMOND, 32)));
		prizes.add(new Prize(bundle.getString("5000"), new ItemStack(Material.DOUBLE_PLANT, 5)));
		prizes.add(new Prize(bundle.getString("2500"), new ItemStack(Material.DOUBLE_PLANT, 2)));
		...
		prizes.add(new Prize(bundle.getString("BatSpawner"), new ItemStack(Material.MOB_SPAWNER, 1)));
		prizes.add(new Prize(bundle.getString("DiamondPackage"), new ItemStack(Material.DIAMOND_AXE, 1)));
		prizes.add(new Prize(bundle.getString("5Creepers"), new ItemStack(Material.MONSTER_EGG, 5, (short) 50)));
		prizes.add(new Prize(bundle.getString("64TNT"), new ItemStack(Material.TNT, 64)));
