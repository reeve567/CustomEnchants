...
public class CustomBlockEnchantLoader {

	private List<ACustomBlockEnchant> customBlockEnchantHashMap = new ArrayList<>();

	public CustomBlockEnchantLoader() {
		customBlockEnchantHashMap.add(new ACustomBlockEnchant("Lumberjack", ItemSets.AXE, Rarity.RARE, "Mining the bottom log in a tree++will drop all the wood.", Material.LOG) {
	...
	public List<ACustomBlockEnchant> getCustomBlockEnchants() {
		return customBlockEnchantHashMap;
	}
}
